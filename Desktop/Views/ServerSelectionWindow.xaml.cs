...
namespace Desktop.Views
{
    public partial class ServerSelectionWindow
    {
        ...
        private void LoadServers()
        {
            ...
            var linkColor = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#ffffff"));
        ...
        private void ServerFilterTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
