...
namespace Desktop.Views
{
    public partial class MainPage
    {
            ...
            try
            {
                ...
                if (_selectedServer != null)
                {
                    ...
                    ServerTextBlock.Inlines.Add(new Run
                    {
                        ...
                        FontSize = 14,
                        Foreground = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#184c91"))
                    });
                ...
                if (_bestServer != null)
                {
                    ...
                    ServerTextBlock.Inlines.Add(new Run
                    {
                        ...
                        FontSize = 14,
                        Foreground = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#3067af"))
                    });
        ...
        {
            SelectServerLink.Foreground = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#3067af"));
